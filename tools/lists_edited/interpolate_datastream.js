function (head, req) {
	...
	//var absence_idx = map.field("OfficeOccupied");    // THIJS
	var absence_idx = map.field(stream);    // THIJS
	
	// Start the JSON response object
	...
	// Start looping through all the data rows and update the meta object accordingly
	while (row = getRow()) {
