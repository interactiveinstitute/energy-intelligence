...
(function() {
  this.Chart = (function() {
    ...
    function Chart(config, db) {
      ...
      this.y = d3.scale.linear().domain([0, 200]);
    ...
    Chart.prototype.autopan = function(domain) {
      ...
      d3.transition().duration(1000).tween('zoom', function() {
        ...
        return _this.loadData(true, domain, function() {
    ...
    Chart.prototype.loadData = function(first, domain, callback) {
      ...
      this.getJSON(url, function(result) {
        ...
        BubbleBath.position();
        BubbleBath.load([_this.display[0].feed], _this.x.domain()[0], _this.x.domain()[1]);
